...
> [!IMPORTANT]
> **This is a play-planning agent.** It is not an urban-planning tool or a generic multi-day itinerary generator. It understands the user's current context, explores several activity ideas, grounds them in real places, and organizes them into routes that can actually be followed.
