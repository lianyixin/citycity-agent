...
<p align="center">
  ...
  <a href="https://www.xiaohongshu.com/user/profile/62aa83ef000000001b02b574"><img src="https://img.shields.io/badge/Xiaohongshu-400_followers-ff2442" alt="Xiaohongshu: 400 followers" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-blue" alt="MIT License" /></a>
</p>

CityCity Agent turns an open-ended request such as “What can I do around Shanghai Changning tonight?” into **several grounded city-play routes**. A Planner Agent creates diverse branches; bounded parallel Execute Agents search, evaluate, and expand those branches against real POI data.

## 🚀 Key differentiators

| | Typical travel agent | **CityCity Agent** |
| --- | --- | --- |
| **Planning style** | Often commits early to **one** itinerary | Explores **N play routes in parallel**, then lets the user choose |
| **Product focus** | Multi-day travel: hotels, flights, long transfers | **Citywalk / city activity planning**: what to do in the next few hours or one day |
| **Grounding** | Easy to drift into generic advice | Map POIs validate each branch before composing routes |

> [!IMPORTANT]
> **1. Parallel multi-route planning first.** Most travel agents answer with a single plan. CityCity Agent runs multiple Execute Agents concurrently so one query can return several different playable routes at once.
>
> **2. City activity planning first.** This is not a generic multi-day travel agent. It is built for citywalk, dates, family outings, food trips, photography, and nightlife—scenarios where the question is “what should we do around here now?”
...
Routes generated by this project are also published on Xiaohongshu account [上海 City 不 City](https://www.xiaohongshu.com/user/profile/62aa83ef000000001b02b574) (**400 followers**).
